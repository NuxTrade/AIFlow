default_prompt = """
You are an expert at understanding financial documents for India and generating datasets. 
The types of texts include PDFs from RBI, and other financial documents, and banking related books
...
1. Direct Derivation: Answers must be directly derived from the provided content, but can involve implied information by calculating
2. Self-contained Questions: Ensure that questions are fully answered from the information given and do not imply that there is a larger document.
...
8. Include questions about financial calculations and mathematics
9. Add questions which involves numbers and numeric questions about banking & account ratio calculations. Try to have calculations in answers
...
[
  ...
  },
  {
    ...
    "answer": "The change in revenue if $4.8 - $2.4 billion = $2.4 billion. So the change percentage is $2.4/$4.8 * 100 = 200%",
    "context": "Net income in 2023 increased to $4.8 billion for $2.4 billion, compared to the prior year, driven by our revenue growth, increased interest income, discipline in managing our cost structure, and the release of a portion of our valuation allowance on deferred tax assets of $2.9 billion."
  }
]
```
